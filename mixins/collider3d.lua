...
function c3d:c3dMove(posx, posy, posz)
    ...
    return actualX + self.w / 2, actualY + self.h, actualZ
end
...
local function drawItem(item)
    ...
    -- back side
    setAlpha(0.4)
    love.graphics.rectangle("fill", x - d, y - d - z, w, h)
    setAlpha(0.6)
    love.graphics.rectangle("line", x - d, y - d - z, w, h)
    love.graphics.setColor(1, 1, 1, 1)
end
